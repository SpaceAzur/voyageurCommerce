...
coordonnees_villes = liste_coordonnees_villes_from_csv('data/burma14.csv')
...
dessiner_parcours_voyageur_commerce(coordonnees_float, '7, 10, 8, 0, 1, 13, 11, 5, 6, 12, 2, 3, 9, 4')